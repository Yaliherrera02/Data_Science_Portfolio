...
--TODO EL SIGUIENTE BLOQUE DE CODIGO SE PUEDE DESCOMENTAR
"""
...
select u.nombre, c. id_cuota, p.monto_solicitado, c.monto_cuota, c.fecha_vencimiento
from ((usuarios u 
...
where estado_pago='mora'
;
--El Reporte de Cobranzas (Detalle de cuotas en mora)
select u.nombre, c. id_cuota, p.monto_solicitado, c.monto_cuota, c.fecha_vencimiento
from ((usuarios u 
inner join prestamos as p
on u.id_usuario = p.id_usuario )
